...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const updateCards = () => {
      ...
      const scrollProgress = Math.max(0, Math.min(1, rawProgress * 0.5));
                ...
                <div className="col-lg-6 col-sm-12">
                    <div className="formContect">
                        <div className="formarea">
                            <form
                                action="http://www.kincgroup.com/Career/sendmail"
                                name="career_form"
                                id="career_form"
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-12 col-md-12">
                                        <div className="btnarea text-right">
                                            ...
                                            <button type="submit" className="btn_comman btn_primary1" href="javascript:void(0)">Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
